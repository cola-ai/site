...
public class UsuarioViewModel {
    ...
    @NotBlank
    @Size(min=2, max=255)
    @Pattern(regexp="^[a-z,A-Z,áéíóúàâêôãõüçÁÉÍÓÚÀÂÊÔÃÕÜÇ, ,-]", message="Nome não pode conter números!")
    private String nome;
    
    @NotNull
    @NotBlank
    @Size(min=2, max=255)
    @Pattern(regexp="[a-z,A-Z, ,-]+", message="Sobrenome não pode conter números!")
